...
namespace aergo::module
{
    ...
    public:
        ...
        virtual void addOwner(ISharedData* data) = 0;
        
        /// @brief Remove owner from shared data object. Object removed when owners drop to zero.
        virtual void removeOwner(ISharedData* data) = 0;
    };
    ...
    public:
        ...
        virtual IAllocatorCore* createDynamicAllocator() = 0;
        ...
        virtual IAllocatorCore* createBufferAllocator(uint64_t slot_size_bytes, uint32_t number_of_slots) = 0;

        /// @brief Delete previously created allocator.
        virtual void deleteAllocator(IAllocatorCore* allocator) = 0;
    };
