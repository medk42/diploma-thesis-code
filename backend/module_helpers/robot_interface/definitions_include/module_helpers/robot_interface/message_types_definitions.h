...
namespace aergo::module::helpers::robot_interface
{
    ...
    constexpr aergo::module::communication_channel::Consumer robot_interface_status_consumer = {
        .count_ = aergo::module::communication_channel::Consumer::Count::SINGLE,
        .channel_type_identifier_ = robot_interface_status_producer.channel_type_identifier_,
        .display_name_ = robot_interface_status_producer.display_name_,
        .display_description_ = robot_interface_status_producer.display_description_,
        .prioritized_ = true,
    ...
    constexpr aergo::module::communication_channel::Consumer robot_interface_finished_consumer = {
        .count_ = aergo::module::communication_channel::Consumer::Count::SINGLE,
        .channel_type_identifier_ = robot_interface_finished_producer.channel_type_identifier_,
        .display_name_ = robot_interface_finished_producer.display_name_,
        .display_description_ = robot_interface_finished_producer.display_description_,
        .prioritized_ = true,
        .message_queue_capacity_ = 16
    };
}