...
static constexpr communication_channel::Producer module_publish_producers[] = {
    { 
        .channel_type_identifier_ = "message_5/v1:int",
        .display_name_ = "Message 5", 
...
static constexpr ModuleInfo module_info = {
    .module_type_identifier_ = "module_d",
    .display_name_ = "Module D",
    .display_description_ = "",
...
{
    auto module = std::make_unique<aergo::tests::core_1::ModuleD>(data_path, core, channel_map_info, logger, module_id, &module_info);
    if (module->valid())
    {
