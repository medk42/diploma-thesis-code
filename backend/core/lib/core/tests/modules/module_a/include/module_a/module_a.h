...
namespace aergo::tests::core_1
{
    ...
    {
    public:
        ModuleA(aergo::module::ICore* core, aergo::module::InputChannelMapInfo channel_map_info, const aergo::module::logging::ILogger* logger, uint64_t module_id) : ModuleWrapper(core, channel_map_info, logger, module_id, 10) {}
