...
TEST_CASE( "DynamicAllocator", "[dynamic_allocator]" )
{
    ...
    SECTION("working allocator")
    {
        ...
        SharedDataCore* data_core = (SharedDataCore*)data.data();

        REQUIRE(data_core->counter() == 0);
        REQUIRE_NOTHROW(dynamic_allocator.addOwnerImpl((aergo::module::ISharedData*)data.data()));
        REQUIRE(data_core->counter() == 1);
        REQUIRE_NOTHROW(dynamic_allocator.addOwnerImpl((aergo::module::ISharedData*)data.data()));
        REQUIRE(data_core->counter() == 2);
        REQUIRE_NOTHROW(dynamic_allocator.removeOwnerImpl((aergo::module::ISharedData*)data.data()));
        REQUIRE(data_core->counter() == 1);
        REQUIRE_NOTHROW(dynamic_allocator.addOwnerImpl((aergo::module::ISharedData*)data.data()));
        REQUIRE(data_core->counter() == 2);
        REQUIRE_NOTHROW(dynamic_allocator.addOwnerImpl((aergo::module::ISharedData*)data.data()));
        ...
        aergo::module::message::SharedDataBlob data1, data2, data3;
        ...
        SharedDataCore* data1_core = (SharedDataCore*)data1.data();
        SharedDataCore* data2_core = (SharedDataCore*)data2.data();
        SharedDataCore* data3_core = (SharedDataCore*)data3.data();
        REQUIRE(data1_core->counter() == 0);
        REQUIRE(data2_core->counter() == 0);
        REQUIRE(data3_core->counter() == 0);
        REQUIRE(memory_allocator.operations().size() == 5);

        REQUIRE_NOTHROW(dynamic_allocator.removeOwnerImpl((aergo::module::ISharedData*)data2.data()));
        ...
        REQUIRE_NOTHROW(dynamic_allocator.addOwnerImpl((aergo::module::ISharedData*)data1.data()));
        REQUIRE_NOTHROW(dynamic_allocator.addOwnerImpl((aergo::module::ISharedData*)data3.data()));
        REQUIRE_NOTHROW(dynamic_allocator.addOwnerImpl((aergo::module::ISharedData*)data1.data()));
        REQUIRE_NOTHROW(dynamic_allocator.addOwnerImpl((aergo::module::ISharedData*)data1.data()));
        REQUIRE_NOTHROW(dynamic_allocator.addOwnerImpl((aergo::module::ISharedData*)data3.data()));
        REQUIRE(logger.logs().size() == 0);
        ...
        REQUIRE_NOTHROW(dynamic_allocator.removeOwnerImpl((aergo::module::ISharedData*)data3.data()));
        REQUIRE_NOTHROW(dynamic_allocator.removeOwnerImpl((aergo::module::ISharedData*)data1.data()));
        REQUIRE(logger.logs().size() == 0);
    ...
    SECTION("real memory allocation test")
    {
        ...
        aergo::module::message::SharedDataBlob data100, data42, data1100, data100000;
        ...
        REQUIRE_NOTHROW(dynamic_allocator.addOwnerImpl((aergo::module::ISharedData*)data100.data()));
        REQUIRE_NOTHROW(dynamic_allocator.addOwnerImpl((aergo::module::ISharedData*)data100.data()));
        REQUIRE_NOTHROW(dynamic_allocator.addOwnerImpl((aergo::module::ISharedData*)data42.data()));
        REQUIRE_NOTHROW(dynamic_allocator.addOwnerImpl((aergo::module::ISharedData*)data1100.data()));
        REQUIRE_NOTHROW(dynamic_allocator.addOwnerImpl((aergo::module::ISharedData*)data1100.data()));
        REQUIRE_NOTHROW(dynamic_allocator.addOwnerImpl((aergo::module::ISharedData*)data1100.data()));
        ...
        REQUIRE_NOTHROW(dynamic_allocator.removeOwnerImpl((aergo::module::ISharedData*)data100.data()));
        REQUIRE_NOTHROW(dynamic_allocator.removeOwnerImpl((aergo::module::ISharedData*)data42.data()));
        REQUIRE_NOTHROW(dynamic_allocator.removeOwnerImpl((aergo::module::ISharedData*)data1100.data()));
        REQUIRE_NOTHROW(dynamic_allocator.removeOwnerImpl((aergo::module::ISharedData*)data100000.data()));
