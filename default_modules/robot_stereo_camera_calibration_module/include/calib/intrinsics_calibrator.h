...
namespace aergo::default_modules::robot_stereo_camera_calibration_module::calib
{
    ...
    public:
        struct Params
        {
            ...
            int flags{ cv::CALIB_RATIONAL_MODEL | cv::CALIB_ZERO_TANGENT_DIST };
        ...
        Result calibrate(const std::vector<CharucoDetection>& views,
    ...
    private:
        ...
        void buildCharucoArrays(const std::vector<CharucoDetection>& views,
                                const CharucoBoardModel& board,
