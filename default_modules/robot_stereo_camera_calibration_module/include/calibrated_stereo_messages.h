...
namespace aergo::default_modules::robot_stereo_camera_calibration_module::messages
{
    ...
    inline constexpr aergo::module::communication_channel::Producer calibrated_stereo_publish_producer{
        ...
        .display_description_ = "Calibrated stereo camera poses (world<-camL/camR) and intrinsics with original stereo blob."
    };
    ...
    inline void parseCalibratedStereoRobotMountedCamera(
