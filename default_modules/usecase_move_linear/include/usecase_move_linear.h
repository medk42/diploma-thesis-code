...
namespace aergo::default_modules::usecase_move_linear
{
    namespace uw = aergo::module::helpers::usecase_wrapper;
    namespace rc = aergo::module::helpers::robot_interface::robot_control;

    class UsecaseMoveLinear : public aergo::module::helpers::base_usecase::BaseUsecase
    {
    public:
        UsecaseMoveLinear(
        ...
        ~UsecaseMoveLinear() noexcept override = default;
