...
static constexpr ModuleInfo module_info = {
    .module_type_identifier_ = "usecase_move_trajectory",
    .display_name_ = "Usecase Move Trajectory",
    .display_description_ = "Usecase module for moving the robot along a trajectory. The trajectory is specified as a sequence of poses in the world coordinate system.",
...
std::string usecase_name = "MOVE_T";
std::string usecase_desc = "Usecase for moving the robot along a trajectory. The trajectory is specified as a sequence of poses in the world coordinate system.";

p_desc::ParameterList auto_parameters(std::move(std::vector<p_desc::ParameterDescription>{
    {
        .type_ = p_desc::ParameterType::CUSTOM,
        .param_name_ = "Trajectory",
        .param_desc_ = "Trajectory as a sequence of poses in the world coordinate system using the pen's current pose.",
...
p_desc::ParameterList advanced_parameters(std::move(std::vector<p_desc::ParameterDescription>{
    {
        ...
        .param_desc_ = "Speed at which the robot should move along the trajectory.",
        .limit_min_ = true,
        .limit_max_ = true,
    ...
    },
    {
        ...
        .param_desc_ = "Acceleration at which the robot should move along the trajectory.",
        .limit_min_ = true,
        .limit_max_ = true,
        .min_value_double_ = 10,
    ...
    },
    {
        ...
        .param_name_ = "Trajectory Orientation Type",
...
{
    auto module = std::make_unique<aergo::default_modules::usecase_move_trajectory::UsecaseMoveTrajectory>(data_path, core, channel_map_info, logger, module_id, &module_info, multi_program_support, pause_support, stop_support);
    if (!module->valid())
    {
        return nullptr;
    }
