...
namespace aergo::default_modules::robot_module_kassow::robot_vis::robot_model::a1018 {
    ...
    inline constexpr std::array<JointDesc, 11> kJoints = {
        ...
        JointDesc{"joint2", "link2", "link3", {0.000000f, 0.000000f, 0.339600f}, {0.000000f, 0.000000f, 0.000000f}, {0.000000f, 0.000000f, 1.000000f}, true},
        ...
        JointDesc{"joint4", "link4", "link5", {0.000000f, 0.000000f, 0.376400f}, {0.000000f, 0.000000f, 0.000000f}, {0.000000f, 0.000000f, 1.000000f}, true},
    ...
    inline constexpr std::array<vis3d::CylinderDesc, 10> kCylinders = {
        ...
        vis3d::CylinderDesc{ 0.050000f, 0.025000f, 0.339600f },
        vis3d::CylinderDesc{ 0.050000f, 0.025000f, 0.189611f },
        vis3d::CylinderDesc{ 0.050000f, 0.025000f, 0.099219f },
        vis3d::CylinderDesc{ 0.050000f, 0.025000f, 0.376400f },
