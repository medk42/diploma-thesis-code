...
namespace aergo::default_modules::robot_module_kassow::robot_vis::robot_model::a1805 {
    ...
    inline constexpr std::array<JointDesc, 11> kJoints = {
        ...
        JointDesc{"joint1", "link1", "linkJ2", {0.062000f, 0.000000f, 0.322100f}, {0.000000f, 0.000000f, 0.000000f}, {0.000000f, 1.000000f, 0.000000f}, true},
        ...
        JointDesc{"joint2", "link2", "link3", {0.000000f, 0.000000f, 0.739610f}, {0.000000f, 0.000000f, 0.000000f}, {0.000000f, 0.000000f, 1.000000f}, true},
        JointDesc{"joint3", "link3", "linkJ4", {0.050000f, 0.000000f, 0.182890f}, {0.000000f, 0.000000f, 0.000000f}, {0.000000f, 1.000000f, 0.000000f}, true},
        ...
        JointDesc{"joint4", "link4", "link5", {0.000000f, 0.000000f, 0.777600f}, {0.000000f, 0.000000f, 0.000000f}, {0.000000f, 0.000000f, 1.000000f}, true},
        JointDesc{"joint5", "link5", "linkJ6", {0.000000f, 0.000000f, 0.099900f}, {0.000000f, 0.000000f, 0.000000f}, {0.000000f, 1.000000f, 0.000000f}, true},
    ...
    inline constexpr std::array<vis3d::CylinderDesc, 10> kCylinders = {
        ...
        vis3d::CylinderDesc{ 0.050000f, 0.025000f, 0.328013f },
        vis3d::CylinderDesc{ 0.050000f, 0.025000f, 0.122111f },
        vis3d::CylinderDesc{ 0.050000f, 0.025000f, 0.739610f },
        vis3d::CylinderDesc{ 0.050000f, 0.025000f, 0.189602f },
        vis3d::CylinderDesc{ 0.050000f, 0.025000f, 0.099219f },
        vis3d::CylinderDesc{ 0.050000f, 0.025000f, 0.777600f },
        vis3d::CylinderDesc{ 0.050000f, 0.025000f, 0.099900f },
