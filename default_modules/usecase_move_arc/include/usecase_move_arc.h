...
namespace aergo::default_modules::usecase_move_arc
{
    namespace uw = aergo::module::helpers::usecase_wrapper;
    namespace rc = aergo::module::helpers::robot_interface::robot_control;

    class UsecaseMoveArc : public aergo::module::helpers::base_usecase::BaseUsecase
    {
    public:
        UsecaseMoveArc(
        ...
        ~UsecaseMoveArc() noexcept override = default;
